...
public class TaskStatusTypeController {
     ...
     */
    @GetMapping("/{statusId}")
    public TaskStatusEntity findById(@PathVariable Integer statusId){
     ...
     */
    @PostMapping
    public boolean add(@RequestBody TaskStatusEntity taskStatusType){
     ...
     */
    @PutMapping("/{statusId}")
    public boolean update(@PathVariable Integer statusId,@RequestBody TaskStatusEntity taskStatusType){
